  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-[80vh] px-4">
      ...
      <div className="flex flex-row items-center justify-center gap-4 pt-4">
        <Link href="/videos">
          <Button size="lg" className="font-semibold text-lg px-8 py-6 bg-gradient-to-t from-red-600 to-red-400 hover:opacity-90 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.03]">
            Get Started Free →
          </Button>
        </Link>
